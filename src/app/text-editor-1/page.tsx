    ...
    return (
        <div className="bg-slate-50">
            <div className="container mx-auto p-4 w-full relative ">
                <button className="absolute top-4 left-4 bg-[#1fce93] text-white px-4 py-2 rounded-md cursor-pointer" onClick={() => router.push("/")}><ArrowLeftIcon /></button>
                <h1 className="text-3xl font-bold text-center mb-8 mt-4 text-gray-800">Edit Text Editor</h1>
